<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
  <div class="container flex items-center justify-end h-full px-6 mx-auto text-red-600 dark:text-red-300">
    ...
    <ul class="flex items-center flex-shrink-2 space-x-6">
      ...
      <li class="flex">
        <button
          class="rounded-md p-2 text-gray-600 transition-colors duration-200 hover:bg-gray-200 dark:text-gray-300 dark:hover:bg-gray-700"
      ...
      <!-- Profile menu -->
      <li class="relative">
        <button class="align-middle rounded-full focus:shadow-outline-red focus:outline-none" @click="toggleProfileMenu"
          @keydown.escape="closeProfileMenu" aria-label="Account" aria-haspopup="true">
          <img class="object-cover w-8 h-8 rounded-full" src="{{ asset('assets/img/logo.png') }}" alt="Profile"
            aria-hidden="true" />
        </button>
