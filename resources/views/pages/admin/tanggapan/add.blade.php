      ...
      <form action="{{ route('tanggapan.store')}} " method="POST" enctype="multipart/form-data">
        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
          <label class="block text-sm">
            <span class="text-gray-700 dark:text-gray-400">Tanggapan <span class="text-red-600">*</span></span>
            <textarea
          ...
          <div>
            ...
            <input type="file" class="block w-full border border-gray-500 dark:border-gray-600 dark:text-white" name="foto" accept="image/*" required>
          </div>
          ...
          <button type="submit"
            class="mt-4 w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red">
            Tanggapi
          </button>
        </div>
      </form>
