      ...
      <form action="{{ route('pengaduan.store')}} " method="POST" enctype="multipart/form-data">
        ...
        <div class="px-4 py-3 mb-8 bg-red-300 rounded-lg shadow-xl border-2 dark:bg-gray-800">
          ...
          <select name="jenis" id="jenis"
            ...
            <option value="Pelayanan Sekolah">Pelayanan Sekolah</option>
            <option value="Guru dan Tenaga Kependidikan">Guru dan Tenaga Kependidikan</option>
            <option value="Keamanan Sekolah">Keamanan Sekolah</option>
